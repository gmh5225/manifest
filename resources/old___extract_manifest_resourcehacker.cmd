...
call "bin\ResourceHacker\ResourceHacker.exe" -open "%FILE_TARGET%" -save ".\manifests.rc" -action extract -mask 24,, -log ".\resourcehacker.log"

::-out:"%FILE_TARGET%.extracted.manifest"
